...
export const Component = () => {
  ...
  return (
    <button
      className="group relative rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 active:scale-105"
      onMouseEnter={() => setIsHovering(true)}
      onMouseLeave={() => setIsHovering(false)}
    >
      <div className="relative flex items-center justify-center gap-2 rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 px-4 py-2 text-white">
        ...
        <span className="font-semibold block lg:hidden">CV</span>
        <span className="font-semibold hidden lg:block">Download CV</span>
      </div>
      {!!particleState && (
        <Particles
          id="whatever"
